...
text = codecs.open('silsigan_new.txt','r','utf-8')
doc_ko = text.read()

# 단어 대체하기
replace_dic = {'추천':'','베스트':'','때문':'','관련':'','대한':'','따위':'','따름':'','나위':'','대로':'','만큼':'','마리':'','가마':'','묶음':'','바리':''
               ,'오늘':'','내일':'','듯이':'','종류':'','테야':'','사람':'','그릇':'','덩어리':'','발자국':'','군데':'','채로':''
               ,'이것':'','저것':'','그루':'','무엇':'','우리':'','누구':'','너희':'','어디':'','언제':'','통해':'','이하':'','이상':''
